...
<div class="container mt-4">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('petugas.order_service.update', $orderService->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="quantity" class="form-control" value="{{ $orderService->quantity }}" min="1" required>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('petugas.order_service.index') }}" class="btn btn-secondary">Kembali</a>
